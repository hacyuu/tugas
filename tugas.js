...
//     const orang1 = new person("roy","abdul","55");
//     orang1.name = ''
//     orang1.setage = '-9'
    
//     const karyawan2 = new person("hacyu","uuu","22");
//     karyawan2.name = ''
//     karyawan2.setage = '-3'
...
//  
//   const hac = new Ebook("black clover", "Yuki tabata", 2015, 90000);
//   console.log(hac.bookDetail());
  
//  
//   hac.title = ""; 
//   hac.price = "invalidPrice"; 
//   console.log(hac.bookDetail());
...
//   let karyawan1 = new Manager('Abiyyu', 100000, 'BUMN');
//   console.log(karyawan1.hitungGajiTahunan());
  
//   let karyawan2 = new Manager('nopal', 40000, 'Kominfo');
...
//   let produk1 = new ElectronicProduk("1", "kulkas", "300000", 3, 1);
//   let produk2 = new ElectronicProduk("2", "tremos", 25000, 2, 1);
...
class AkunBank {
    ...
    this.#saldo += jumlah;
    console.log(
`        Uang sebesar ${jumlah} disetorkan. Saldo sekarang: ${this.Saldo}
`    );
    }
    ...
    if (jumlah > this.Saldo) {
        console.log(
`        ${this.NamaNasabah} Saldo tidak cukup untuk menarik ${jumlah}. Saldo sekarang: ${this.Saldo}
`        );
    } else {
        this.#saldo -= jumlah;
        console.log(
`        Uang sebesar ${jumlah} ditarik. Saldo sekarang: ${this.Saldo}`  );
    }
    }
    ...
    if (jumlah > this.Saldo) {
        console.log(
`        Saldo tidak cukup untuk di transfer sebanyak ${jumlah}. Saldo anda sekarang: ${this.Saldo}`
        );
    } else {
        this.#saldo -= jumlah;
        console.log(
`        Uang sebesar ${jumlah} telah ditransfer! Saldo anda sekarang: ${this.Saldo}`
      );
    }
    }
}

const rekening = new AkunBank("001", "abi", 200000);
